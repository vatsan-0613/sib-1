  ...
  const products = [
    {
      ...
      image: carousel1,
      description:
        "With lots of unique blocks, you can easily build a page without coding. Build your next landing page. With lots of unique blocks, you can easily build a page without coding. Build your next landing page.",
    },
    {
      id: 2,
      name: "Product Name",
  ...
  return (
    <section id="products">
      <div className="container">
        ...
        <div className="arrow d-flex mb-3 gap-3 mt-3">
          <button
            className="forward left-arrow arrow-btn p-0"
          ...
          <button
            className="Backward arrow-btn p-0"
        ...
        <div className="overflow-hidden">
          <div
            className="carousel d-flex gap-5 ps-5"
            id="product-carousel"
            style={{
              transform: `translateX(-${productSlide * productWidth}px)`,
          ...
          >
            {products.map((product, index) => (
              <div className="product-card" key={product.id}>
                ...
                <p className="para-text">{product.description}</p>
                <p>
                  <span className="b-text fw-semibold">Read More</span>{" "}
                  <img
